...
func (h HandlerV1) CreateOwner(c *gin.Context) {
	...
	if err != nil {
		...
		h.Logger.Error("error read body")
	}
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"massage": "Error hashing possword",
		})
		h.Logger.Error("Error hashing possword")
		return
	}
...
func (h *HandlerV1) DeleteOwner(c *gin.Context) {
	...
	response, err := h.Service.UserService().DeleteOwner(ctx, &pbu.IdRequest{
		Id: id,
	})
