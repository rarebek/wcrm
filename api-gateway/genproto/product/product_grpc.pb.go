...
type ProductServiceClient interface {
	...
	GetAllProductByCategoryId(ctx context.Context, in *GetProductsByCategoryIdRequest, opts ...grpc.CallOption) (*GetAllResponse, error)
...
func (c *productServiceClient) GetAllProductByCategoryId(ctx context.Context, in *GetProductsByCategoryIdRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	out := new(GetAllResponse)
...
type ProductServiceServer interface {
	...
	GetAllProductByCategoryId(context.Context, *GetProductsByCategoryIdRequest) (*GetAllResponse, error)
...
func (UnimplementedProductServiceServer) GetAllProductByCategoryId(context.Context, *GetProductsByCategoryIdRequest) (*GetAllResponse, error) {
