...
func (c *productServiceClient) GetAllProductByCategoryId(ctx context.Context, in *GetProductsByCategoryIdRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	out := new(GetAllResponse)
	err := c.cc.Invoke(ctx, "/ProductService/GetAllProductByCategoryId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) ListCategory(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllCategoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ProductService/ListCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_GetAllProductByCategoryId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ProductService/GetAllProductByCategoryId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_ListCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ProductService/ListCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
